...
etap4.on('message', async msg =>{
    ...
    await Video.create({videotype, description, url})
    await msg.reply('Video qoshganingiz uchun katta rahmat. ', startKeyboard);
    return msg.scene.leave();
})

const videokiritscene = new Scenes.WizardScene('videoqosh', etap1, etap2, etap3, etap4)
module.exports = { videokiritscene }